 ...
 */
public class FormDetalleCompra extends javax.swing.JFrame {
    
    public static String idCompra;

    /**
     * Creates new form FormDetalleCompra
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDetalleCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDetalleCompra().setVisible(true);
            }
        });
    }
