 ...
 */
public class FormDetalleVentas extends javax.swing.JFrame {
    
    public static String idVenta;

    /**
     * Creates new form FormDetalleVentas
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDetalleVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDetalleVentas().setVisible(true);
            }
        });
    }
